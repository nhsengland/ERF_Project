...
* Run SDID analysis
local excelPath "Outputs/Segmented/SDID_Results_Incomplete_Pathways_DTA.xlsx"
...
foreach code in `T_Codes' {
    ...
    foreach depvar in `depvars' {
        ...
        if _rc == 0 {
            ...
            local row = `row' + 1
            graph export "Outputs/Segmented/SDID_Incomplete_Pathways_DTA_`code'_`depvar'.png", replace
        }
        else {
