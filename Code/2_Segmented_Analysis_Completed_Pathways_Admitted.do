...
* Run SDID analysis
local excelPath "Outputs/Segmented/SDID_Results_Completed_Pathways_Admitted.xlsx"
...
foreach code in `T_Codes' {
    ...
    foreach depvar in `depvars' {
        ...
        if _rc == 0 {
            ...
            local row = `row' + 1
            graph export "Outputs/Segmented/SDID_Completed_Pathways_Admitted_`code'_`depvar'.png", replace
        }
        else {
